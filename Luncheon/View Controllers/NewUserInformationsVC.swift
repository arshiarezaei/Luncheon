...
class NewUserInformationsVC: UIViewController {
    ...
    private let verticalSpacepaceBetweenTFs:CGFloat = CGFloat(16)
...
//        confirmInformationButton.addTarget(self, action: #selector(confirmVerficationCodeButtonTapped), for: .touchUpInside)
