...
struct SampleRestaurantManager {
    public static let restaurats : [SampleRestaurant] = [
        SampleRestaurant(id: 1, persianName: "مک دونالد", rate: 4.8, logo: UIImage(named: "Mc donald")!, menus:mcdonaldMenu,food: mcDonalFoodBurger + mcDonald),
    ...
    private static let mcDonalFoodBurger:[SampleFood] = [
        ...
        SampleFood(id: 1, persianName: "دونالد برگر ويژه", rate: 4.6, price: 45000, discountAmount: 1000, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
        SampleFood(id: 2, persianName: "چیز برگر", rate: 3.6, price: 50000, discountAmount: 2000, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
        SampleFood(id: 3, persianName: "چیزبرگر ویژه", rate: 5.0, price: 55000, discountAmount: 0, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
        SampleFood(id: 4, persianName: "چیکن برگر", rate: 5.0, price: 35000, discountAmount: 0, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
        SampleFood(id: 5, persianName: "ماشروم برگر", rate: 5.0, price: 40000, discountAmount: 0, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
    ]
    private static let mcDonald:[SampleFood] = [
        SampleFood(id: 6, persianName: "مرغ سخاری", rate: 5.0, price: 40000, discountAmount: 0, ingredients: [], calorie: 0,image: UIImage(named: "food")!),
        SampleFood(id: 7, persianName: "کتف", rate: 4.6, price: 20000, discountAmount: 1000, ingredients: [], calorie: 0,image: UIImage(named: "1-1-1")!),
    ]
